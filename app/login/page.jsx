  ...
  return (
    <section className="py-14 text-white">
      <div className="container">
        <h2 className="text-3xl pb-4 text-center">LogIn with social media</h2>
      ...
      {/* Facebook Button */}
      <button
        className="flex items-center bg-blue-600 text-white border border-blue-600 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
      >
        <svg
          className="h-6 w-6 mr-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      {/* Twitter Button */}
      <button
        className="flex items-center bg-blue-400 text-white border border-blue-400 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-300"
      >
        <svg
          className="h-6 w-6 mr-2"
          xmlns="http://www.w3.org/2000/svg"
      ...
      {/* Email Button */}
      <button
        className="flex items-center bg-gray-200 text-gray-800 border border-gray-400 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
      >
        <svg
          className="h-6 w-6 mr-2"
          xmlns="http://www.w3.org/2000/svg"
